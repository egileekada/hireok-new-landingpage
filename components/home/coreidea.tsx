...
export default function CoreIdea() {
    return (
        <LandingLayout reverse={true} >
                ...
                <div className=" flex flex-col gap-3 " >
                    <p className=" text-[30px] lg:leading-[100%] font-black " >Start in minutes</p>
                ...
                <p className=" lg:text-base text-sm font-black mt-4 ">Everything you need, in one dashboard.</p>
        </LandingLayout>
    );
}
